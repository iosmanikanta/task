...
- (void)viewDidLoad {
    ...
    TableViewController *locationSearchTable = [storyboard instantiateViewControllerWithIdentifier:@"TVC"];
...
- (IBAction)get:(id)sender {
    ...
    [_latititudeLbl setText:AD.latitude];
    [_longitudeLbl setText:AD.longitude];
